...
# %% Read in pool results

# df1 = pd.read_csv('rf_pool 1.csv', index_col=0)
# df2 = pd.read_csv('rf_pool 2.csv', index_col=0)
# df3 = pd.read_csv('rf_pool 3.csv', index_col=0)

# Keep in mind that dictionaries do not have orders. Lists do.
...
event_dff.to_csv('events_rf_pool.csv')
