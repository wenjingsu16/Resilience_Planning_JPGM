...
# This file is used to process results from ALFA matlab
# The reduced scenarios are draw in pictures and extracted to dataframe
# Also draw the results of the deterministic equivalent expansion model

#For different runs, change ne_list, scenario list txt and figure name
...
# ne_list = [16, 21, 221, 23, (3, 4), (6, 11), (9, 10), (6, 13)] # Cost 5
# ne_list=[14,19,21,221,23,(10,11),(13,14),(2,4),(4,5),(6,12),(9,10)] #Cost 10
ne_list=[15,17,19,21,221,23,(1,5),(4,9),(9,10)] #Use5
...
alfa_list = []
# f = open('cost_sample10.txt')
# f = open('cost_sample5.txt')
f = open('use_sample5.txt')
for line in f:
...
event_df = pd.read_csv('events.csv', index_col=0)
...
plt.savefig('Use5_System_Expansion.png',dpi=1000)
# plt.savefig('Cost10_System_Expansion.png',dpi=1000)
# plt.savefig('Cost5_System_Expansion.png',dpi=1000)
plt.show()

# %% print out the reduced event dataframe
# re: reducted events based on unserved energy or cost
# selected_df.to_csv('re_cost10.csv')
